...
gulp.task('copyNodeModules', function () {
    return gulp.src(nodeModulesSrc)
...
gulp.task('watch', ['clean'], function(done){
  runSequence(
    ['sass', 'html', 'fonts', 'scripts', "copyNodeModules"],
    function(){
...
//JKR: own scripts, because .map

var defaultScriptSrc = [
...
/*gulp.task('scripts', function(options) {
  options.src = options.src || defaultScriptSrc;
